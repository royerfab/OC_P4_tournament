...
class Player:
    ...
    def serialize(self):
        player = {'id': self.id, 'last_name': self.last_name, 'first_name': self.first_name,
                  'date_of_birth': self.date_of_birth, 'sexe': self.sexe, 'classement': self.classement,
                  'age': self.age, 'score': self.score}
        return player
    ...
    def deserialize(cls, player):
        ...
        age = player['age']
        player_object = Player(last_name=last_name, first_name=first_name, date_of_birth=date_of_birth, sexe=sexe,
